    ...
    update(dt) {
      ...
      for (const b of [...this.activeBosses]) {
        ...
        if (b.y >= 110) {
          ...
          if (b.homingTimer !== null) {
            ...
            if (b.homingTimer <= 1e-9) {
              ...
              Object.assign(this.hostile[this.hostile.length - 1], { homing: true, lifetime: 10, r: 7 });
            }
          }
          b.shot -= dt;
          if (b.shot <= 0) {
        ...
        if (b.hp <= 0) {
          ...
          if (!this.boss) {
            this.hostile = []; this.nextBoss = this.elapsed + 30;
            if (b.kind === 'wave') {
      ...
      for (const b of this.hostile) {
        if (b.homing) {
          b.lifetime -= dt;
          if (b.lifetime <= 0) { b.dead = true; continue; }

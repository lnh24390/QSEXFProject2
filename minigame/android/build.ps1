...
$apk = Join-Path $outputDir 'NeonDrift-2.0.0-debug.apk'
...
[IO.File]::WriteAllText((Join-Path $outputDir 'NeonDrift-2.0.0-debug.apk.sha256'), "$hash  NeonDrift-2.0.0-debug.apk`n", $utf8)

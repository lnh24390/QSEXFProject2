...
$apk = Join-Path $outputDir 'Neondrift-2.0.2-debug.apk'
...
[IO.File]::WriteAllText((Join-Path $outputDir 'Neondrift-2.0.2-debug.apk.sha256'), "$hash  Neondrift-2.0.2-debug.apk`n", $utf8)
